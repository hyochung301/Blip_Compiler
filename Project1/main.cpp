...
//    char superstrings[] = " Hyello  wye re witxing this wzithoutA BanyC purnctuation fit fit fitt rtheequirements ofthe project\n"
...
void generalTest(void) {
    ...
    readFile("strings11.txt", strings);
    readFile("superstrings11.txt", superstrings);
